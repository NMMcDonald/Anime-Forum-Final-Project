...
def get_formatted_posts(topic):
    ...
    for post in posts:
        ...
        formatted_posts = formatted_posts  + Markup('<div class="BD"><p>'+ post["username"] + "</p><p>"+  post["post"]+'</p><button name="Up" value="'+post ["_id"]+'"><i onclick="myFunction(this)" class="fa fa-thumbs-up"></i><i onclick="myFunction(this)" class="fa fa-thumbs-down"></i></button></div>')
